...
#' 
#' p <- dbd_prob(t = 1, a0 = 10, b0 = 0, drates1, brates2, drates2, trans12, a = 0, B = 50) # transition probabilities
#' 
#' @export
dbd_prob <- function(t, a0, b0, mu1, lambda2, mu2, gamma, a=0, B,
  ...
  ## a>=0, a<=a0, B >=a0+b0-a 
  if(a < 0) stop("a can not be negative.")
  if (a > a0) stop("a can not be bigger than a0.")
