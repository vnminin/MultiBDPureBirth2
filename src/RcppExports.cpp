...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< std::complex<double> >::type s(sSEXP );
        Rcpp::traits::input_parameter< int >::type a0(a0SEXP );
        Rcpp::traits::input_parameter< int >::type b0(b0SEXP );
        Rcpp::traits::input_parameter< std::vector<double> >::type lambda1(lambda1SEXP );
        Rcpp::traits::input_parameter< std::vector<double> >::type lambda2(lambda2SEXP );
        Rcpp::traits::input_parameter< std::vector<double> >::type mu2(mu2SEXP );
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< int >::type a(aSEXP );
        Rcpp::traits::input_parameter< int >::type B(BSEXP );
        Rcpp::traits::input_parameter< std::vector<double> >::type mat(matSEXP );
